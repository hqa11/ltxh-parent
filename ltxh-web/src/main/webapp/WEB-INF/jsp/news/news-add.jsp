			...
			<form action="" method="post" class="form form-horizontal" id="form-articl-add">
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入新闻标题" maxlength="50" id="news_title" name="news_title" datatype="*" nullmsg="新闻标题不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-4">
						<input type="text" class="input-text" value="" placeholder="请输入新闻简介" id="news_desc" name="news_desc"  datatype="*" nullmsg="新闻简介不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入发布人" id="news_release_person" name="news_release_person"  datatype="*" nullmsg="发布人不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
...
//2.发送请求
$.post("saveNews.action",params,function(data){
