...
<html>
			...
			<form action="" method="post" class="form form-horizontal" id="form-articl-add">
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入供求标题" maxlength="50" id="g_title" name="g_title" datatype="*" nullmsg="供求标题不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入供求别名" id="g_other_name" name="g_other_name"  datatype="*" nullmsg="供求别名不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入供求品种" id="g_goods_type" name="g_goods_type"  datatype="*" nullmsg="供求品种不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入联系人" id="g_contact_person" name="g_contact_person"  datatype="*" nullmsg="联系人不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入联系电话" id="g_contact_phone" name="g_contact_phone"  datatype="/^1[3,4,5,7,8]\d{9}$/" nullmsg="联系电话不能为空！"  errormsg="请输入正确的电话号码!">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-1">
						<input type="text" class="input-text" value="" placeholder="请输入供求单位" id="g_unit" name="g_unit"  datatype="*" nullmsg="供求单位不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-4">
						<input type="text" class="input-text" value="" placeholder="请输入产品信息" id="g_goods_msg" name="g_goods_msg"  datatype="*" nullmsg="产品信息不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入供应价格" id="g_goods_price" name="g_goods_price"  datatype="/^[1-9]\d*(\.\d{1,2})?$|0\.\d{1,2}$/" nullmsg="供应价格不能为空！" errormsg="请输入正确的金额!">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					<div class="col-10 col-offset-2">
						<button onClick="saveGoods();" class="btn btn-primary radius" type="button">
	...
	params+="&picStr="+picStr;
	//2.发送请求
	$.post("saveGoods.action",params,function(data){
