			...
			<form action="" method="post" class="form form-horizontal" id="form-articl-add">
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入消息标题" maxlength="50" id="q_name" name="q_name" datatype="*" nullmsg="问卷标题不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-4">
						<textarea value=""  class="textarea" placeholder="请输入问卷描述...." rows="12" cols="60"  maxlength="500" id="q_desc" name="q_desc" datatype="*" nullmsg="问卷描述不能为空！"></textarea>
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
...
//2.发送请求
$.post("saveQuestion.action",params,function(data){
