			...
			<form action="" method="post" class="form form-horizontal" id="form-articl-add">
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="" placeholder="请输入消息标题" maxlength="50" id="pm_msg_title" name="pm_msg_title" datatype="*" nullmsg="消息标题不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-4">
						<textarea value=""  class="textarea" placeholder="请输入消息内容...." rows="12" cols="60"  maxlength="500" id="pm_msg_content" name="pm_msg_content" datatype="*" nullmsg="消息内容不能为空！"></textarea>
					</div>
					<div class="col-2"></div>
				</div>
...
params+="&fjStr="+fjStr;
//2.发送请求
$.post("saveMsg.action",params,function(data){
