...
<html>
	...
	<body>
		<div class="pd-20">
			...
			<input type="hidden" name="qs_id" value="${survey.qs_id }">
				<div class="row cl">
					<label class="form-label col-2"><span class="c-red">* </span>问 &nbsp;&nbsp;&nbsp;题：</label>
					<div class="formControls col-4">
						<input type="text" class="input-text" value="${survey.qs_subject }" placeholder="请输入问题" maxlength="500" id="qs_subject" name="qs_subject" datatype="*" nullmsg="问题不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="${survey.qs_answer_a }" placeholder="请输入答案" maxlength="50" id="qs_answer_a" name="qs_answer_a" datatype="*" nullmsg="答案不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="${survey.qs_answer_b }" placeholder="请输入答案" maxlength="50" id="qs_answer_b" name="qs_answer_b" datatype="*" nullmsg="答案不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="${survey.qs_answer_c }" placeholder="请输入答案" maxlength="50" id="qs_answer_c" name="qs_answer_c" datatype="*" nullmsg="答案不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="${survey.qs_answer_d }" placeholder="请输入答案" maxlength="50" id="qs_answer_d" name="qs_answer_d" datatype="*" nullmsg="答案不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-2">
						<input type="text" class="input-text" value="${survey.qs_answer_e }" placeholder="请输入答案" maxlength="50" id="qs_answer_e" name="qs_answer_e" datatype="*" nullmsg="答案不能为空！">
					</div>
					<div class="col-2"></div>
				</div>
	...
	$(function(){
	//正确答案回显
	var qs_right_answer = '${survey.qs_right_answer}';
	var arr = qs_right_answer.split(',');
	console.log(arr)
	$('input[type=checkbox][name=qs_right_answer]').each(function(){
	var v = $(this).val();
	if($.inArray(v,arr) != -1){
	...
	//2.发送请求
	$.post("updateSurvey.action",params,function(data){
